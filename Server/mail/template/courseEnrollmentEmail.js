    ...
    <head>
        ...
        <body>
             <div class="container">
                ...
                <div class="body">
                    <p>Dear ${name},</p>
                    <p>You have successfully registred for the course <span class="highlight">${courseName}</span> we are excited to have you as a participant!</p>
                    <p>Please log in to your learning dashboard to access the course materials and start you learning</p>
